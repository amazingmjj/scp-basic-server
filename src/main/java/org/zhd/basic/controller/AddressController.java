...
public class AddressController extends BaseController{
     ...
     * @throws Exception
     */
    @GetMapping("api/basic/address/queryCombo")
    public List<Address> queryCombo(String name,String code) throws Exception{
        return addressService.queryTreeList(name,code);
    }
